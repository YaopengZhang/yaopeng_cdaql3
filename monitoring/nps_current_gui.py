...
def calcRates(rates,rates2,time_diff):
    ...
    for ii in range(len(XVALS)):
        ...
        zz_diff=zz2-zz
        total+=(zz_diff)/tt/5.12e7-Pedestals[ii]
        if ((zz_diff)/tt/5.12e7-Pedestals[ii])>maximum: maximum=(zz_diff)/tt/5.12e7-Pedestals[ii]
...
def main():
    ...
    while True:
        ...
        for ii in range(len(zvals)):
            ...
            Current_Value = (zvals2[ii]-zvals[ii])/t_diff[ii]/5.12e7-Pedestals[ii]
