...
def getScalars():
    ...
    lines = subprocess.check_output(["getscalers","hcvme01"])
...
def main():
    ...
    while True:
        ...
        zvals2 = getScalars()
        for ii in range(len(zvals)):
            hh.SetBinContent(xax.FindBin(XVALS[ii]+1),yax.FindBin(18-YVALS[ii]),(zvals2[ii]-zvals[ii])/10.)
            hi.SetBinContent(xax.FindBin(XVALS[ii]+1),yax.FindBin(18-YVALS[ii]),(zvals2[ii]-zvals[ii])/10.)
