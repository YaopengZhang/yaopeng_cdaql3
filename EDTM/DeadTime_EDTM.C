...
void DeadTime_EDTM(Int_t RunNo){
    TString FilePath_PS = "/net/cdaq/cdaql1data/cdaq/hallc-online-nps2023/REPORT_OUTPUT/COIN/HMSONLY/";
    TString Input_File_PS = FilePath_PS + Form("scaler_report_%d.report",RunNo);
    ifstream inputFile(Input_File_PS);
    // ifstream inputFile("/net/cdaq/cdaql1data/cdaq/hallc-online-nps2023/REPORT_OUTPUT/COIN/HMSONLY/coin_HMS_report_1513_10000.report");
    ...
    // TString FilePath = "/net/cdaq/cdaql1data/cdaq/hallc-online-nps2023/ROOTFiles/COIN/PRODUCTION/";
    TString FilePath = "/net/cdaq/cdaql1data/cdaq/hallc-online-nps2023/ROOTFiles/NPS/SCALERS/";
    // TString FilePath = "/volatile/hallc/nps/cmorean/ROOTfiles/COIN/PRODUCTION/";
    // TString Input_File = FilePath + FileName;
    ...
    // for(Long64_t iEntry = 0; iEntry < 20000; ++iEntry){
        ...
        // cout<<H_hL1ACCP_scaler<<"\t"<<H_hTRIG5_scaler<<"\t"<<H_hTRIG6_scaler<<endl;
        ...
        // cout<<iEntry<<"\t"<<H_EDTM_scaler<<endl;
