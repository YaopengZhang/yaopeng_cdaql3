...
TFile *myfile;
  ...
  TH1F *sh_for_eff = new TH1F("", "", 150, 0.01, 1.5);
  ...
  //  for(Int_t i=0; i < 20000; i++){
    ...
    if (track_nr > 0 && edtm == 0.){
      ...
      if(ng_npe>9. && shtrk>0.7 && delta > -10. && delta < 22.){
  ...
  cout << " elecs from 1840: " << int_elec_only << endl;
    ...
    c3->cd(1);
    formatit(xfp, "1.4 GeV/c , th = 25 deg, ELCLEAN", "P.dc.x[0]","Events",0);
    formatit_diff(xfp_del_cut, "delta: -10 to +22", "P.dc.x[0]","Events",1);

    c3->cd(2);
    formatit(prsh, "1.4 GeV/c , th = 25 deg, ELCLEAN", "","Events",0);
    ...
    c3->cd(3);
    formatit(npes, "1.4 GeV/c , th = 25 deg, ELCLEAN", "NGC NPEs", "Events",0);
    ...
    c3->cd(4);
    formatit(x_at_ng, "1.4 GeV/c , th = 25 deg, ELCLEAN", "P.ngcer.xAtCer","Events",0);
   ...
   TCanvas *c4 = new TCanvas("c4","",900,900);
    ...
    formatit(shtrk_all, "1.4 GeV/c , th = 25 deg, ELCLEAN", "","Events",0);
   ...
   TCanvas *c6 = new TCanvas("c6","",900,900);
    ...
    c6->cd(1);
    formatit_2d(xp1, "1.4 GeV/c , th = 25 deg, ELCLEAN", "xp","PrShower",0);
    c6->cd(2);
    formatit_2d(xp2, "1.4 GeV/c , th = 25 deg, ELCLEAN", "xp","NGC Npe",0);


    c6->Print("test4_1840.png"); 
