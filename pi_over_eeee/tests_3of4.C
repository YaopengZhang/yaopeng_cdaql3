...
TFile *myfile;
 ...
 chain.SetBranchAddress("P.hgcer.npeSum", &hg_npe);        
  ...
  TH1F* npes = new TH1F("", "", 70, 0., 30.);
  TH1F* hgcer_strange = new TH1F("", "", 70, 0., 30.);
  TH1F* hgcer_all = new TH1F("", "", 70, 0., 30.);
  TH1F* npes_notrack = new TH1F("", "", 70, 0., 30.);
  TH1F* npes_low_del = new TH1F("", "", 70, 0., 30.);
  TH1F* npes_del_cut = new TH1F("", "", 70, 0., 30.);
  ...
  cout << " elecs from 1913: " << int_elec_only << endl;
    ...
    c1->Divide(1,1);
    c1->cd(1);
    formatit(hgcer_all, "1.4 GeV/c , th = 25 deg, 3/4", "NGC NPEs ALL", "Events",0);
    formatit_diff2(hgcer_strange, "1.4 GeV/c , th = 25 deg, 3/4", "HGC NPEs Strange", "Events",0);
    


    c1->Print("test0_1913.png"); 
