...
TFile *myfile;
  ...
  chain.Add("/net/cdaq/cdaql3data/cdaq/simona/ROOTfiles2/shms_replay_production_1839_-1.root");
  ...
  cout << " elecs from 1839: " << int_elec_only << endl;
   ...
   TCanvas *c4 = new TCanvas("c4","",900,900);
    ...
    formatit(shtrk_all, "1.4 GeV/c , th = 25 deg, ELREAL", "","Events",1);
   ...
   TCanvas *c6 = new TCanvas("c6","",900,900);
    ...
    c6->cd(1);
    formatit_2d(xp1, "1.4 GeV/c , th = 25 deg, ELREAL", "xp","PrShower",1);
    c6->cd(2);
    formatit_2d(xp2, "1.4 GeV/c , th = 25 deg, ELREAL", "xp","NGC Npe",0);


    c6->Print("test4_1839.png"); 
   ...
   TCanvas *c7 = new TCanvas("c7","",900,900);
    ...
    c7->cd(1);
    formatit_2d(x_vs_y_strange, "1.4 GeV/c , th = 25 deg, ELREAL", "y","x",0);
    c7->cd(2);
