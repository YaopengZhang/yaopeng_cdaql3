...
void formatit(TH1F *histo, TString bar, TString xax, TString yax, Int_t flag){
  ...
  TLegend* leg = new TLegend(0.15,0.9,0.35,0.95);
  leg->SetFillColor(-1);
  leg->SetFillStyle(0);
...
void formatit_diff(TH1F *histo, TString bar, TString xax, TString yax, Int_t flag){
  ...
  TLegend* leg = new TLegend(0.15,0.85,0.35,0.9);
  leg->SetFillColor(-1);
  leg->SetFillStyle(0);
  leg->SetTextSize(0.045);
...
void formatit_diff2(TH1F *histo, TString bar, TString xax, TString yax, Int_t flag){
  ...
  TLegend* leg = new TLegend(0.15,0.8,0.35,0.85);
  leg->SetFillColor(-1);
  leg->SetFillStyle(0);
  leg->SetTextSize(0.045);
...
void formatit_diff3(TH1F *histo, TString bar, TString xax, TString yax, Int_t flag){
  ...
  TLegend* leg = new TLegend(0.15,0.75,0.35,0.8);
  leg->SetFillColor(-1);
  leg->SetFillStyle(0);
  leg->SetTextSize(0.045);
...
void formatit_diff4(TH1F *histo, TString bar, TString xax, TString yax, Int_t flag){
  ...
  TLegend* leg = new TLegend(0.15,0.7,0.35,0.75);
  leg->SetFillColor(-1);
  leg->SetFillStyle(0);
  leg->SetTextSize(0.045);
...
void formatit_diff5(TH1F *histo, TString bar, TString xax, TString yax, Int_t flag){
  ...
  TLegend* leg = new TLegend(0.15,0.65,0.35,0.7);
  leg->SetFillColor(-1);
  leg->SetFillStyle(0);
  leg->SetTextSize(0.045);
...
void formatit_diff6(TH1F *histo, TString bar, TString xax, TString yax, Int_t flag){
  ...
  TLegend* leg = new TLegend(0.15,0.6,0.35,0.65);
  leg->SetFillColor(-1);
  leg->SetFillStyle(0);
  leg->SetTextSize(0.045);
...
void formatit_diff7(TH1F *histo, TString bar, TString xax, TString yax, Int_t flag){
  ...
  TLegend* leg = new TLegend(0.15,0.55,0.35,0.6);
  leg->SetFillColor(-1);
  leg->SetFillStyle(0);
  leg->SetTextSize(0.045);
...
void formatit_diff8(TH1F *histo, TString bar, TString xax, TString yax, Int_t flag){
  ...
  TLegend* leg = new TLegend(0.15,0.5,0.35,0.55);
  leg->SetFillColor(-1);
  leg->SetFillStyle(0);
  leg->SetTextSize(0.045);
...
void formatit_2d(TH2F *histo, TString bar, TString xax, TString yax, Int_t flag){
  ...
  TLegend* leg = new TLegend(0.25,0.85,0.45,0.95);
  leg->SetFillColor(-1);
  leg->SetFillStyle(0);
...
TFile *myfile;
  ...
  chain.Add("/net/cdaq/cdaql1data/cdaq/hallc-online-pionLT/ROOTfiles/Analysis/General/Full_Online_coin_replay_12260_500001.root");
    
  TString FilePath = "/net/cdaq/cdaql1data/cdaq/hallc-online-pionLT/ROOTfiles/Analysis/General/";
  // TString FilePath = "/net/cdaq/cdaql1data/cdaq/hallc-online-pionLT/ROOTfiles/Analysis/PionLT/2022_Run/";
  // Maybe try one of the "nocut" files so you can see the whole spectrum.
  TString FileName = FilePath + "Full_Online_coin_replay_14966_500000.root";
  chain.Add(FileName);
  ...
  Double_t prlo, prhi, shlo, ceramp, shadc, prshadc, edtm, legngcer, certdc, ello, elhi, ellolo;
  ...
  c3->Print("effect_all_legs_on_elec_pions_hms_12260.png"); 
  ...
  c4->Print("effect_of_cerleg_hms_12260.png"); 
  ...
  c5->Print("effect_all_legs_on_all_hms_12260.png"); 
  ...
  c58->Print("prsh_all_elec_puions_12260.png");
  ...
  c59->Print("2d_sh_vs_pr_12260.png");
  ...
  c68->Print("prsh_sum_adc_12260.png");
  ...
  c69->Print("sh_sum_adc_12260.png");
  ...
  c699->Print("cher_sum_adc_12260.png");
  ...
  c99->Print("2d_prsum_adc_12260.png");
  ...
  c199->Print("2d_shsum_adc_12260.png");
